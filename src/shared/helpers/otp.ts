...
export async function storeOTP(email: string, hash: string, ttlSeconds = 120): Promise<void> {
...
export async function getStoredOTP(email: string): Promise<{ hash: string; expiresAt: Date } | null> {
